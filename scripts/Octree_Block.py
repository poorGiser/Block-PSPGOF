...
def is_convex_polygon(polygon):
    ...
    return True
def scence_block(colmap_data_path,x_block_num,z_block_num,bound_extend,visibility_threshold,near,far,invalid_image_names = None):
    ...
    split_block_path = os.path.join(colmap_data_path,"blocks_manh_octree")
    ...
    # pcd_removed = remove_outliers_pcn(pcd)
    # pcd_removed = remove_outliers_pcn(pcd_removed)
        
    #计算点云边界
    scene_range = (np.min(pcd.points,axis=0), np.max(pcd.points,axis=0))
    ...
    plt.savefig(colmap_data_path + "/cameras_octree.png")
    plt.clf()
...
if __name__ == "__main__":
    colmap_data_path = "/home/chenyi/gaussian-opacity-fields-main/gaussian-opacity-fields-main/data/campus"
    invalid_image_names = []
    ...
    scence_block(colmap_data_path,x_block_num,z_block_num,bound_extend,visibility_threshold,near,far,invalid_image_names)