...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 image_name, uid,
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0,width=None,height=None,resolution=None, data_device = "cuda"
                 ):
    ...
    def load_in_cuda(self):
        self.original_image.to(self.data_device)
    def load_in_cpu(self):
