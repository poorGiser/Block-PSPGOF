...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.sample_more_highres = False#更多的使用高分辨率图片
        self.use_decoupled_appearance = True#vast gaussian
...
class PipelineParams(ParamGroup):
    def __init__(self, parser):
        ...
        # self.compute_view2gaussian_python = True
        self.debug = False
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        #二维化部分Gaussian
        self. plane_from_iter = 3000
        self.plane_interval = 100
        self.lambda_plane = 10.0
        # self.plane_iso = 3.0
        # self.plane_iso = 5.0
        self.plane_iso = 2.0
