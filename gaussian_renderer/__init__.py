...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, kernel_size: float, scaling_modifier = 1.0, override_color = None, subpixel_offset=None,rt_depths = False,mask=None):
    """
    Render the scene. 
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        subpixel_offset=subpixel_offset,#1
        bg=bg_color,
    ...
    if mask is not None:
        ...
        # if view2gaussian_precomp:
        #     view2gaussian_precomp = view2gaussian_precomp[mask]
        ...
        # if view2gaussian_precomp:
        #     view2gaussian_precomp = view2gaussian_precomp.to(device)
    ...
    if not rt_depths:
        ...
        # color, radii, mode_id, modes, alpha_depth, out_means2D, out_conic_opacity, point_list
        rendered_image, radii,mode_id,modes,alpha_depth,out_means2D, out_conic_opacity, point_list = rasterizer(
            means3D = means3D,
            means2D = means2D,
            shs = shs,
            colors_precomp = colors_precomp,
        ...
        return {"render": rendered_image,
                ...
                "point_list": point_list,
                "means2D": out_means2D,
                "conic_opacity": out_conic_opacity
                }
